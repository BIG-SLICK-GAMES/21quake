...
const QUAKESessionSchema = new mongoose.Schema(
  {
    iUserId: {
  ...
  { collection: 'QUAKE_sessions', timestamps: { createdAt: 'dCreatedDate', updatedAt: 'dUpdatedDate' } }
);

QUAKESessionSchema.index({ iUserId: 1, eStatus: 1, dCreatedDate: -1 });

module.exports =
  mongoose.models.QUAKE_sessions || mongoose.model('QUAKE_sessions', QUAKESessionSchema);
