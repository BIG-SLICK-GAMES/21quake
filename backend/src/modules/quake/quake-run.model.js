...
const QUAKERunSchema = new mongoose.Schema(
  {
    iUserId: {
  ...
  { collection: 'quake_runs', timestamps: { createdAt: 'dCreatedDate', updatedAt: 'dUpdatedDate' } }
);

QUAKERunSchema.index({ nAdjustedScore: -1, nLinesCompleted: -1, dCreatedDate: -1 });

module.exports = mongoose.models.quake_runs || mongoose.model('quake_runs', QUAKERunSchema);
