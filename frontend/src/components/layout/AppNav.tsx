...
const NAV_ITEMS: Array<{
  ...
  { icon: "cards-playing", key: "game", path: QUAKERoutes.lobby },
  { icon: "gift", key: "daily", path: QUAKERoutes.rewards },
  { icon: "trophy", key: "leaderboards", path: QUAKERoutes.leaderboard },
  { icon: "account-circle", key: "profile", path: QUAKERoutes.profile },
  { icon: "share-variant", key: "social", path: QUAKERoutes.social },
  ...(HOLD_EM_URL ? [{ icon: "cards" as const, key: "holdem" as const, url: HOLD_EM_URL }] : []),
  {
    icon: "cog",
    key: "settings",
    path: { pathname: QUAKERoutes.profile, params: { section: "settings" } }
  }
];

const PATH_TO_KEY: Record<string, AppNavKey> = {
  [String(QUAKERoutes.lobby)]: "game",
  [String(QUAKERoutes.rewards)]: "daily",
  [String(QUAKERoutes.leaderboard)]: "leaderboards",
  [String(QUAKERoutes.profile)]: "profile",
  [String(QUAKERoutes.social)]: "social",
  [String(QUAKERoutes.settings)]: "settings"
};
