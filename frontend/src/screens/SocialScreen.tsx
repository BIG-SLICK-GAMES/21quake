...
export function SocialScreen() {
  ...
  const postText = useMemo(() => {
    ...
    return `I just played 21 Quake. Beat my run and stack chips with me.${tagSuffix}${linkSuffix}`;
  }, [referralLink, tags]);
  ...
  function saveRecordingToDevice() {
    ...
    link.href = url;
    link.download = `21-quake-${Date.now()}.webm`;
  ...
  async function copyReferralLink() {
    ...
    await Share.share({ message: referralLink, title: "21 Quake referral" });
  }
