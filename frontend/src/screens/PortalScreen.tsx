            ...
            {isAuthenticated ? (
              <>
                <GameButton
                  ...
                  label="21 Quake"
                  onPress={() => {
                    router.push(QUAKERoutes.lobby);
                  }}
                  subtitle="Open the Quake lobby"
                  tone="primary"
                />
              ...
              <>
                ...
                <View style={styles.secondaryActions}>
                  <SmallAction
                    ...
                    label="Register"
                    onPress={() => {
                      router.push({ pathname: QUAKERoutes.auth, params: { mode: "register" } } as Href);
                    }}
                  />
                  <SmallAction
                    icon="lock-reset"
