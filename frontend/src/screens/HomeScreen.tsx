...
export function HomeScreen() {
  ...
  useEffect(() => {
    ...
    async function hydrateQUAKEStatus() {
        ...
        {status === "authenticated" ? (
          <View style={styles.menuActionRow}>
            <MenuButton
              icon="account-edit"
              label="Edit Profile"
              onPress={() => navigate(QUAKERoutes.profile)}
              primary
            />
            <MenuButton
              icon="logout"
          ...
          <View style={styles.menuActionRow}>
            <MenuButton
              ...
              label="Sign In"
              onPress={() =>
                navigate({ pathname: QUAKERoutes.auth, params: { mode: "login" } } as Href)
              }
              primary
            />
            <MenuButton
              ...
              label="Create"
              onPress={() =>
                navigate({ pathname: QUAKERoutes.auth, params: { mode: "register" } } as Href)
              }
            />
          </View>
        )}
