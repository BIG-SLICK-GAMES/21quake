...
const THEMES: Record<VisualThemeKey, Pick<QUAKEAppearance, "bannerAccent" | "bannerGlowCool" | "bannerGlowWarm" | "bannerGradient">> = {
  classic: {
    bannerAccent: "#ffd678",
...
const BOARDS: Record<BoardPaletteKey, Pick<QUAKEAppearance, "boardBackground" | "boardBorder" | "cellBackground" | "cellBorder" | "cellPlayableBorder" | "lineLockedBackground" | "lineNeutralBackground" | "lineText">> = {
  felt: {
...
const TILES: Record<TilePaletteKey, Pick<QUAKEAppearance, "tileCoreGlow" | "tileGloss" | "tileRank" | "tileSurface">> = {
  ivory: {
...
export function getQUAKEAppearance(settings: {
