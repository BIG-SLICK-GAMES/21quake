# QUAKE Economy Manual Test Notes
...
6. Insufficient chips: after using free games, set chips below 50 and verify start is blocked with `You need 50 chips to play another QUAKE game`.
...
10. Leaderboard: verify successful 21s update `totalQUAKEChipsWon`, `successful21Count`, `bestSingleWin`, and `gamesPlayed`.
